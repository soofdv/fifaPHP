...
<div class="container">
    ...
    <form class="set-timeform" action="controller.php" method="post">
        ...
        <input class="addreferee-input" type="text" name="fieldname" id="fieldname" placeholder="Veld Naam">

        <button style="color: white;" class="addteam-button" id="addreferee-submit" type="submit"> Toevoegen </button>
